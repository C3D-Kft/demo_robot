...
def generate_steps(sorted_steps, mot_index):
    ...
    lépéslistából és a hozzá rendelt motortengely-index listából olyan
    szekvenciát generál, amelyben az összes tengely mozgása egyszerre
    fejeződik be.
    """

    size = len(sorted_steps)
