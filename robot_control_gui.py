...
class App:
    def __init__(self, master):
        ...
        axis_1_unit_label.grid(
            row=0, column=2, sticky='WE', padx=(5, 0), pady=(0, 5))
        axis_2_unit_label = tk.Label(
            act_pos_label_frame, text="fok", anchor="w",
            font=(self.fty, self.fsize)
        )
        axis_2_unit_label.grid(
            row=1, column=2, sticky='WE', padx=(5, 0), pady=(5, 5)
        )
        ...
        axis_3_unit_label.grid(
            row=2, column=2, sticky='WE', padx=(5, 0), pady=(5, 0)
        )
        ...
        axis_1_label_stp.grid(
            row=0, column=0, sticky='WE', padx=(0, 10), pady=(0, 5)
        )
        ...
        axis_2_label_stp.grid(
            row=1, column=0, sticky='WE', padx=(0, 10), pady=(5, 5)
        )
        ...
        axis_3_label_stp.grid(
            row=2, column=0, sticky='WE', padx=(0, 10), pady=(5, 0)
        )
        ...
        axis_3_unit_label_stp.grid(
            row=2, column=2, sticky='WE', padx=(5, 0), pady=(5, 5)
        )
        ...
        self.send_to_position_but.grid(
            row=0, column=0, sticky="NWSE", pady=(5, 0), padx=2.5
        )
        ...
        self.follow_route_but.grid(
            row=1, column=0, sticky="NWSE", pady=2.5, padx=2.5
        )
    ...
    def follow_route(self):
        ...
        try:
            ...
            secondary_thread = threading.Thread(
                target=self.move_absolute_loop,
                args=([data])
            )  # <-- check for syntax !!
            secondary_thread.start()
